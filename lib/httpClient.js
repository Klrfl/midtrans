...
import { MidtransError } from './midtransError.js';
...
export class HttpClient {
  ...
  request(
    ...
    let headers = {
      ...
      'user-agent': 'midtransclient-nodejs/1.5.0',
    };
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (
        typeof reqBodyPayload === 'string' ||
        reqBodyPayload instanceof String
      ) {
        try {
      ...
      // Reject if param is not JSON
      if (
        typeof reqQueryParam === 'string' ||
        reqQueryParam instanceof String
      ) {
        try {
